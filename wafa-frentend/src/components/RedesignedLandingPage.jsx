  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-background text-foreground">
      ...
      <main>
        ...
        <section className="px-4 py-20 sm:px-6 lg:px-8"><div className="mx-auto max-w-6xl overflow-hidden rounded-3xl bg-primary px-6 py-10 text-primary-foreground sm:px-10 sm:py-14"><div className="grid gap-6 lg:grid-cols-[1fr_auto] lg:items-end"><div><span className="inline-flex rounded-full bg-white/10 px-3 py-1 text-xs font-semibold tracking-[.12em] text-cyan-100 uppercase">IMRS</span><h2 className="mt-5 text-3xl font-bold tracking-tight sm:text-4xl">{text.contact}</h2><p className="mt-3 max-w-2xl text-primary-foreground/75">{text.contactCopy}</p></div><div className="flex flex-col gap-3 sm:flex-row"><Button asChild size="lg" className="bg-cyan-300 text-[#10235c] hover:bg-cyan-200"><a href={`mailto:${settings.contactEmail || FALLBACK_SETTINGS.contactEmail}`}>{text.write}</a></Button><Button asChild size="lg" variant="outline" className="border-white/35 bg-transparent text-white hover:bg-white/10 hover:text-white"><Link to="/register">{text.continue}</Link></Button></div></div></div></section>
      </main>
